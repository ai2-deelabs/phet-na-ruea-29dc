...
Brand:
เพชรนาะเรือ (Phet Na Ruea) is a sewage pumping service. Modern and bold, oversized headline type, high-contrast accent colour.

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
dense modular grid of stacked rectangular cards (service list styled like a plumbing manifest/blueprint), no hero image, type-as-image headline running vertically along the left rail — monochromatic palette built entirely from a single industrial cyan-blue hue (like a JetBrains Darcula-adjacent IDE theme): #061014, #0E2B33, #1C5866, #2FA9BD, #BFEFF5 — technical typewriter/mono headline type mixed with tiny caption-sized sans — cool, procedural, engineer's-manual precision
